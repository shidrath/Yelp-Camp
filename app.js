...
/**
 * ---- Not in use since version 6.0.1---------
...
// need it to post request into a form
...
passport.serializeUser(User.serializeUser()); // how do you store the user inside a session
passport.deserializeUser(User.deserializeUser());// how do you remove the user out of the session
